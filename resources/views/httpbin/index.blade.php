...
<li><a href="/httpbin/uuid" data-bare-link="true"><code>/uuid</code></a> Returns UUID4.</li>
...
<li><a href="/httpbin/anything" data-bare-link="true"><code>/anything</code></a> Returns request data, including method used.</li>
<li><code>/anything/:anything</code> Returns request data, including the URL.</li>
<li><a href="/httpbin/base64/aGVsbG8gd29ybGQNCg%3D%3D"><code>/base64/:value</code></a> Decodes base64url-encoded string.</li>
...
<li><a href="/httpbin/brotli" data-bare-link="true"><code>/brotli</code></a> Returns brotli-encoded data.</li>
<li><a href="/httpbin/status/418"><code>/status/:code</code></a> Returns given HTTP Status code.</li>
<li><a href="/httpbin/response-headers?Server=httpbin&amp;Content-Type=text%2Fplain%3B+charset%3DUTF-8"><code>/response-headers?key=val</code></a> Returns given response headers.</li>
...
<li><a href="/httpbin/redirect-to?status_code=307&amp;url=http%3A%2F%2Fexample.com%2F"><code>/redirect-to?url=foo&status_code=307</code></a> 307 Redirects to the <em>foo</em> URL.</li>
...
<li><a href="/httpbin/cookies/set?k1=v1&amp;k2=v2"><code>/cookies/set?name=value</code></a> Sets one or more simple cookies.</li>
<li><a href="/httpbin/cookies/delete?k1=&amp;k2="><code>/cookies/delete?name</code></a> Deletes one or more simple cookies.</li>
...
<li><a href="/httpbin/digest-auth/auth/user/passwd/MD5/never"><code>/digest-auth/:qop/:user/:passwd/:algorithm</code></a> Challenges HTTP Digest Auth.</li>
<li><a href="/httpbin/digest-auth/auth/user/passwd/MD5/never"><code>/digest-auth/:qop/:user/:passwd</code></a> Challenges HTTP Digest Auth.</li>
<li><a href="/httpbin/stream/20"><code>/stream/:n</code></a> Streams <em>min(n, 100)</em> lines.</li>
<li><a href="/httpbin/delay/3"><code>/delay/:n</code></a> Delays responding for <em>min(n, 10)</em> seconds.</li>
<li><a href="/httpbin/drip?code=200&amp;numbytes=5&amp;duration=5"><code>/drip?numbytes=n&amp;duration=s&amp;delay=s&amp;code=code</code></a> Drips data over a duration after an optional initial delay, then (optionally) returns with the given status code.</li>
...
<li><a href="/httpbin/etag/etag"><code>/etag/:etag</code></a> Assumes the resource has the given etag and responds to If-None-Match header with a 200 or 304 and If-Match with a 200 or 412 as appropriate.</li>
...
<li><a href="/httpbin/stream-bytes/1024"><code>/stream-bytes/:n</code></a> Streams <em>n</em> random bytes of binary data in chunked encoding, accepts optional <em>seed</em> and <em>chunk_size</em> integer parameters.</li>
<li><a href="/httpbin/links/10"><code>/links/:n</code></a> Returns page containing <em>n</em> HTML links.</li>
<li><a href="/httpbin/image"><code>/image</code></a> Returns page containing an image based on sent Accept header.</li>
<li><a href="/httpbin/image/png"><code>/image/png</code></a> Returns a PNG image.</li>
<li><a href="/httpbin/image/jpeg"><code>/image/jpeg</code></a> Returns a JPEG image.</li>
<li><a href="/httpbin/image/webp"><code>/image/webp</code></a> Returns a WEBP image.</li>
<li><a href="/httpbin/image/svg"><code>/image/svg</code></a> Returns a SVG image.</li>
