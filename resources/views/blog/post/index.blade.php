        ...
        <div class="col-xs-8">
            <h4>
                ...
                <div class="pull-right">
                    <a class="btn btn-default btn-xs" href="{{ route('post.create') }}">
                        <i class="glyphicon glyphicon-plus"></i><span>新增文章</span>
                    </a>
                </div>
                @endif
                <!-- 標題 -->
                            ...
                            <div class="col-md-8">
                                ...
                                <form method="post" action="{{ route('post.destroy', ['post'=>$post->id] ) }}">
                                    ...
                                    <span style="padding-left: 10px;">
                                        <a href="{{ route('post.edit', ['post'=>$post->id]) }}" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-pencil"></i><span style="padding-left:15px;">編輯文章</span></a>
                                    </span>
                                    <input type="hidden" name="_method" value="DELETE"
                                    />
